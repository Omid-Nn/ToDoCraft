"""
این ماژول مسئول خواندن و نوشتن لیست تسک‌ها از/به فایل cli_tasks.json است.
"""

import json
import os

TASKS_FILE = 'cli_tasks.json'

def load_tasks():
    """
    بارگذاری تسک‌ها از فایل cli_tasks.json.
...
def save_tasks(tasks):
    """
    ذخیره لیست تسک‌ها در فایل cli_tasks.json.
